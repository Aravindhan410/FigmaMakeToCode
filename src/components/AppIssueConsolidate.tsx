...
export default function AppIssueConsolidate() {
  ...
  const [consolidateData] = useState<ConsolidateData[]>([
    {
      sNo: 1,
      date: '10-Jul-2025',
      course: 'DPHARM',
  ...
  // Calculate totals
  const totalApplications = consolidateData.reduce((sum, item) => sum + item.numberOfApplications, 0);
  const totalAmount = consolidateData.reduce((sum, item) => sum + item.amount, 0);
  ...
  const handleClose = () => {
    console.log('Closing App Issue Consolidate');
  };
              ...
              >
                ...
                <div className="max-w-[900px] mx-auto border-2 border-black">
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      {consolidateData.map((item) => (
                        <tr key={item.sNo} className="border-b-2 border-black">
                      ...
                      {/* Total Row */}
                      <tr className="border-b-2 border-black">
                        <td colSpan={3} className="border-r-2 border-black p-2 text-center text-sm">
                          TOTAL
                        </td>
                        <td className="border-r-2 border-black p-2 text-center text-sm">
                          {totalApplications}
                      ...
                      {/* Footer Summary Row */}
                      <tr>
                        <td colSpan={3} className="border-r-2 border-black p-3 text-sm">
