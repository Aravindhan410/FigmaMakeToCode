        ...
        <div className="bg-[#6b8aa8] p-4 rounded-lg">
          ...
          <div className="bg-[#5a7a9a] p-3 rounded mb-2">
            <div className="grid grid-cols-12 gap-3 items-start">
              ...
              <div className="col-span-2">
                ...
                {regNo && <div className="text-white text-sm mt-1">{studentName}</div>}
              </div>
          ...
          <div className="bg-[#a0a8b0] p-4 rounded">
            <div className="bg-white rounded shadow-lg max-h-[600px] overflow-auto">
              ...
              >
                {/* Course Completion Certificate Document */}
                <div className="max-w-[800px] mx-auto border-4 border-orange-400 p-1">
                  <div className="border-2 border-orange-400 p-8">
                    ...
                    {!withoutHeader && letterPadFormat && (
                      <div className="flex items-start gap-4 mb-6">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs">Approved by Pharmacy Council of India, New Delhi and Affiliated to Dr. MGR Medical University, Chennai</p>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="text-center border-t-2 border-b-2 border-gray-800 py-2 my-6">
                      <h2 className="text-lg tracking-widest">COURSE COMPLETION CUM CERTIFICATE</h2>
                    </div>

                    {/* Certificate Content */}
                    <div className="space-y-4 text-sm leading-relaxed">
                      <p className="text-justify">
                        This is to certify that <strong>Mr/Ms _________________ Reg. D/o</strong> was a student of this institution. He/She underwent
                      </p>

                      <p className="text-justify">
                        B.Pharm/D.Pharm. Course from <strong><u>{yearFrom}</u></strong> to <strong><u>{yearTo}</u></strong>. He/She completed the Course on _____________. During the
                      </p>

                      <p className="text-justify">
                        period of study. His/Her conduct and character was __________________.
                      </p>
