...
export default function DaywarStatement() {
  ...
  const handleClose = () => {
    console.log('Closing Daywar Statement');
  };
      ...
      <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h3 className="text-xl">DAYWAR STATEMENT</h3>
            <p className="text-sm text-gray-600 mt-2">Day-wise Examination Statement</p>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-400 text-sm">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-400 p-2">Total Students</th>
              </tr>
            </thead>
            <tbody>
              {Array.from({ length: 10 }, (_, idx) => ({
                ...
                course: idx % 2 === 0 ? 'B.Pharm' : 'D.Pharm',
