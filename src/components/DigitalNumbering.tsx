...
export default function DigitalNumbering() {
  ...
  const handleClose = () => {
    console.log('Closing Digital Numbering');
  };
      ...
      <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h3 className="text-xl">DIGITAL NUMBERING</h3>
            <p className="text-sm text-gray-600 mt-2">Student Registration Numbers</p>
          </div>
