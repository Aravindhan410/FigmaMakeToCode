...
export default function DuplicateFinder() {
  ...
  const handleClose = () => {
    console.log('Closing Duplicate Finder');
  };
        ...
        <div className="bg-[#6b8aa8] p-4 rounded-lg">
          ...
          <div className="bg-[#5a7a9a] p-3 rounded mb-2">
            ...
            <div className="flex items-center gap-4 mb-2">
              <Label className="text-white text-sm w-48">Date - Session</Label>
              <Label className="text-white text-sm w-40">Course</Label>
            </div>
            ...
            {/* Third Row - Radio Buttons and Student Search */}
            <div className="bg-[#4a6a8a] p-3 rounded flex items-center justify-between">
              {/* Radio Group */}
          ...
          <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-xl">DUPLICATE FINDER</h3>
                <p className="text-sm text-gray-600 mt-2">Duplicate Registration Detection Report</p>
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-red-600"><strong>Duplicates Found: 8</strong></p>
                  </div>
                </div>
              </div>
              ...
              <table className="w-full border-collapse border border-gray-400 text-sm">
                <thead>
                  <tr className="bg-gray-200">
                    ...
                    <th className="border border-gray-400 p-2">Register No 1</th>
                    <th className="border border-gray-400 p-2">Register No 2</th>
                ...
                <tbody>
                  {Array.from({ length: 8 }, (_, idx) => ({
                    ...
                    <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="border border-gray-400 p-2 text-center">{row.regno1}</td>
                      <td className="border border-gray-400 p-2 text-center">{row.regno2}</td>
                      ...
                      <td className="border border-gray-400 p-2 text-center text-red-600">{row.status}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
