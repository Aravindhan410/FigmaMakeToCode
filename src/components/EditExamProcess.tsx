...
export default function EditExamProcess() {
  ...
  const handleClose = () => {
    console.log('Closing Edit Exam Process');
  };

  const handleUpdate = () => {
    console.log('Updating Exam Process');
  };
          ...
          <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-xl">EDIT EXAM PROCESS</h3>
                <p className="text-sm text-gray-600 mt-2">Examination Process Editing</p>
              </div>
                ...
                <tbody>
                  {Array.from({ length: 15 }, (_, idx) => ({
                    ...
                    <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="border border-gray-400 p-2 text-center">{row.status}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
