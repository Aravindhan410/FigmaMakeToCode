...
export default function Ex2Absent() {
  ...
  const handleClose = () => {
    console.log('Closing Ex2 Absent');
  };
          ...
          <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-xl">FORM Ex2 - ABSENT STUDENTS</h3>
                <p className="text-sm text-gray-600 mt-2">List of Students Absent for Examination</p>
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-red-600"><strong>Total Absent: 8</strong></p>
                  </div>
                </div>
              </div>
                ...
                <tbody>
                  {Array.from({ length: 8 }, (_, idx) => ({
                    ...
                    <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="border border-gray-400 p-2 text-red-600">{row.reason}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
