...
export default function Ex2Present() {
  ...
  const handleClose = () => {
    console.log('Closing Ex2 Present');
  };
          ...
          <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-xl">FORM Ex2 - PRESENT STUDENTS</h3>
                <p className="text-sm text-gray-600 mt-2">List of Students Present for Examination</p>
              </div>
