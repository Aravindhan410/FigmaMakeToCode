...
export default function HallChart() {
  ...
  const handleClose = () => {
    console.log('Closing Hall Chart');
  };
      ...
      <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h3 className="text-xl">HALL CHART</h3>
            <p className="text-sm text-gray-600 mt-2">Examination Hall Allocation</p>
          </div>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="text-sm">
              ...
              <p><strong>Orientation:</strong> {landscape ? 'Landscape' : 'Portrait'}</p>
              {largeHall && <p><strong>Large Hall Mode:</strong> Enabled</p>}
            </div>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-400 text-sm">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-400 p-2">Capacity</th>
                ...
                <th className="border border-gray-400 p-2">Invigilator</th>
              </tr>
            </thead>
            <tbody>
              {[
                { hall: '101', capacity: '25', course: 'B.Pharm', sem: 'I', students: '25', invigilator: 'Dr. Smith' },
                { hall: '102', capacity: '30', course: 'B.Pharm', sem: 'II', students: '28', invigilator: 'Dr. Johnson' },
                { hall: '103', capacity: '25', course: 'D.Pharm', sem: 'I', students: '24', invigilator: 'Dr. Williams' },
                { hall: '104', capacity: '30', course: 'D.Pharm', sem: 'II', students: '30', invigilator: 'Dr. Brown' },
                { hall: '105', capacity: '25', course: 'M.Pharm', sem: 'I', students: '20', invigilator: 'Dr. Davis' },
                { hall: '106', capacity: '30', course: 'M.Pharm', sem: 'II', students: '22', invigilator: 'Dr. Miller' },
                { hall: '107', capacity: '25', course: 'B.Pharm', sem: 'III', students: '25', invigilator: 'Dr. Wilson' },
                { hall: '108', capacity: '30', course: 'B.Pharm', sem: 'IV', students: '29', invigilator: 'Dr. Moore' },
              ].map((row, idx) => (
                <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  <td className="border border-gray-400 p-2 text-center">{row.hall}</td>
                  <td className="border border-gray-400 p-2 text-center">{row.capacity}</td>
                  <td className="border border-gray-400 p-2">{row.course}</td>
                  <td className="border border-gray-400 p-2 text-center">{row.sem}</td>
                  <td className="border border-gray-400 p-2 text-center">{row.students}</td>
                  <td className="border border-gray-400 p-2">{row.invigilator}</td>
                </tr>
              ))}
            </tbody>
            <tfoot>
      ...
      <div className="w-full max-w-[1150px] mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="hallchart" className="mt-0">
            {renderTabContent(false, false, true)}
          </TabsContent>
