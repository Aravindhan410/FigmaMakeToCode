...
export default function MissingBooks() {
  ...
  // Sample missing books data
  const missingBooks = [
    { sno: 1, bookNo: 'BK015', callNo: 'CS305', title: 'Advanced Algorithms', author: 'David Lee', publisher: 'Comp Press', year: '2021', edition: '4th', pages: '580', price: '₹1200', status: 'Missing' },
    { sno: 2, bookNo: 'BK027', callNo: 'PH401', title: 'Clinical Pharmacy', author: 'Sarah Wilson', publisher: 'Med Pub', year: '2020', edition: '2nd', pages: '420', price: '₹980', status: 'Missing' },
    { sno: 3, bookNo: 'BK041', callNo: 'BT501', title: 'Genetic Engineering', author: 'Michael Chen', publisher: 'Bio Books', year: '2022', edition: '3rd', pages: '650', price: '₹1350', status: 'Missing' },
  ];

  return (
    <div className="bg-[#999999] relative size-full" data-name="missing books">
      {/* Top Bar */}
      ...
      <div className="bg-gradient-to-b from-3% from-[rgba(37,87,225,0.8)] via-51% via-[#bdcefa] to-[#f8fafc] h-[calc(100%-100px)] overflow-auto p-6">
        <div className="bg-white rounded-[8px] shadow-[0px_8px_25px_0px_rgba(0,0,0,0.15)] mx-auto" style={{ width: '1099px', maxWidth: '100%' }}>
          {/* Institution Header */}
          ...
          <div className="bg-white h-[40px] flex items-center justify-center -mt-5 mx-auto w-[282px] rounded-[4px]">
            <p className="font-['Arial'] font-bold text-[16px] text-white">MISSING BOOKS REPORT</p>
          </div>
                ...
                {missingBooks.map((book) => (
                  <tr key={book.sno} className="hover:bg-gray-50">
                    ...
                    <td className="border border-gray-700 px-2 py-2 font-['Arial'] text-[10px] text-gray-700 text-center">
                      <div className="h-[17px] w-[16px] bg-red-500 rounded-[3px] mx-auto" title="Missing" />
                    </td>
                  </tr>
                ))}
              </tbody>
