...
export default function QPDistribution() {
  ...
  const handleClose = () => {
    console.log('Closing QP Distribution');
  };
      ...
      <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h3 className="text-xl">QUESTION PAPER DISTRIBUTION</h3>
            <p className="text-sm text-gray-600 mt-2">Hall-wise Question Paper Requirements</p>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-400 text-sm">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-400 p-2">Extra QP</th>
            ...
            <tbody>
              {Array.from({ length: 12 }, (_, idx) => ({
                hall: `${101 + (idx % 8)}`,
                code: `PH${201 + (idx % 5)}`,
                subject: ['Pharmaceutics', 'Pharmaceutical Chemistry', 'Pharmacology', 'Pharmacognosy', 'Biochemistry'][idx % 5],
                required: 25 + (idx * 2),
                extra: 3,
                total: 28 + (idx * 2),
              })).map((row, idx) => (
                <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  ...
                  <td className="border border-gray-400 p-2 text-center">{row.required}</td>
                  <td className="border border-gray-400 p-2 text-center">{row.extra}</td>
                  <td className="border border-gray-400 p-2 text-center">{row.total}</td>
                </tr>
              ))}
            </tbody>
            <tfoot>
          ...
          <div className="mt-8 pt-6 border-t border-gray-300">
            <div className="grid grid-cols-2 gap-8 text-sm">
              ...
              <div className="text-right">
                <p>Verified by Chief Superintendent</p>
