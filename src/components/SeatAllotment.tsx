...
export default function SeatAllotment() {
  ...
  const handleClose = () => {
    console.log('Closing Seat Allotment');
  };
      ...
      <div className="bg-[#525252] rounded p-4 min-h-[500px] overflow-auto">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h3 className="text-xl">SEAT ALLOTMENT</h3>
            <p className="text-sm text-gray-600 mt-2">Examination Seat Arrangement</p>
          </div>
          ...
          <table className="w-full border-collapse border border-gray-400 text-sm">
            <thead>
              <tr className="bg-gray-200">
                <th className="border border-gray-400 p-2">Seat No</th>
            ...
            <tbody>
              {Array.from({ length: 15 }, (_, idx) => ({
                ...
                <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  <td className="border border-gray-400 p-2 text-center">{row.seat}</td>
                  <td className="border border-gray-400 p-2 text-center">{row.roll}</td>
