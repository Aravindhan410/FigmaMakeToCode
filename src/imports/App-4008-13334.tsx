import svgPaths from "./svg-in0wofj65v";
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.07px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">Budget Report</p>
    </div>
  );
}
...
export default function App() {
  return (
    <div className="bg-[#cad5e2] content-stretch flex items-center justify-center relative size-full" data-name="App">
      <Container40 />
    </div>
  );
}