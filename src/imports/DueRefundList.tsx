import svgPaths from "./svg-w39ozfwfmn";
...
function PrimitiveLabel() {
  return (
    <div className="h-[20px] relative shrink-0 w-[121px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center relative w-[121px]">
        <PrimitiveButton />
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] text-nowrap whitespace-pre">Deposit all Paid</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="h-[32px] relative shrink-0 w-[484px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[32px] items-center relative w-[484px]">
        <Label />
        <Input />
        <Label1 />
        <Input />
  ...
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[129.463px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[129.463px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[36.8px] not-italic text-[14px] text-neutral-950 text-nowrap top-[4.8px] whitespace-pre">Due List</p>
      </div>
    </div>
  );
}
...
function Button11() {
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[119.463px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#90a1b9] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[119.463px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[26.8px] not-italic text-[14px] text-neutral-950 text-nowrap top-[4.8px] whitespace-pre">Refund list</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[32px] relative shrink-0 w-[267px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[45px] h-[32px] items-center justify-end relative w-[267px]">
        <Button />
        <Button11 />
      </div>
    </div>
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.57px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">Overall Due List</p>
    </div>
  );
}
...
export default function DueRefundList() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Due / Refund List">
      <App />
    </div>
  );
}