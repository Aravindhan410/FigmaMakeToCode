...
function Button4() {
  return (
    <div className="bg-[#00a63e] h-[36px] relative rounded-[8px] shrink-0 w-[118.963px]" data-name="Button">
...
function Button5() {
  return (
    <div className="bg-[#6a7282] h-[36px] relative rounded-[8px] shrink-0 w-[113.963px]" data-name="Button">
...
export default function EditStudent() {
  return (
    <div className="bg-white relative rounded-[10px] size-full" data-name="Edit Student">
