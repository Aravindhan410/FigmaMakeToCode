import svgPaths from "./svg-pvi1imko4i";
...
function PrimitiveLabel2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[55.763px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center relative w-[55.763px]">
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Fee Type</p>
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[36px] items-center left-[380.48px] top-0 w-[143.762px]" data-name="Container">
      <PrimitiveLabel2 />
      <PrimitiveButton />
    </div>
  );
...
function PrimitiveLabel3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[45px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center relative w-[45px]">
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Course</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[50.4px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center overflow-clip relative rounded-[inherit] w-[50.4px]">
...
function PrimitiveButton1() {
  return (
    <div className="basis-0 bg-white grow h-[36px] min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border-[#d1d5dc] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Container5() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[36px] items-center left-[548.24px] top-0 w-[153px]" data-name="Container">
      <PrimitiveLabel3 />
      <PrimitiveButton1 />
    </div>
  );
...
function PrimitiveLabel4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[30px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center relative w-[30px]">
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Sem</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[36px] items-center left-[725.24px] top-0 w-[98px]" data-name="Container">
      <PrimitiveLabel4 />
      <PrimitiveButton2 />
    </div>
  );
...
function Button() {
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0 w-[74.025px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[6px] h-[32px] items-center justify-center px-[16px] py-0 relative w-[74.025px]">
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-black text-nowrap whitespace-pre">SHOW</p>
      </div>
    </div>
  );
}
...
export default function FeeCollectionDateWise() {
  return (
    <div className="bg-white relative size-full" data-name="Fee Collection / Date Wise">
