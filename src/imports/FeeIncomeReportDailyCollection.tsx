import svgPaths from "./svg-dnxwel5pqk";

function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-[29.012px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[29.012px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-neutral-950 text-nowrap top-[-1.2px] whitespace-pre">Date</p>
      </div>
    </div>
  );
}
...
function Input() {
  return (
    <div className="basis-0 bg-white grow h-[32px] min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Input">
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[37.587px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[37.587px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-neutral-950 text-nowrap top-[-1.2px] whitespace-pre">Today</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="bg-white h-[29.6px] relative rounded-[4px] shrink-0 w-[79.188px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#cad5e2] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[29.6px] items-center pl-[8.8px] pr-[0.8px] py-[0.8px] relative w-[79.188px]">
        <PrimitiveButton />
        <Label1 />
      </div>
    </div>
...
function Container2() {
  return (
    <div className="h-[32px] relative shrink-0 w-[252.2px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[32px] items-center relative w-[252.2px]">
        <Label />
        <Input />
        <Container />
      </div>
  ...
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[129.463px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[129.463px]">
        <Icon />
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[36.8px] not-italic text-[14px] text-neutral-950 text-nowrap top-[4.8px] whitespace-pre">COLLECTION</p>
      </div>
    </div>
  );
}
...
function Button11() {
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[88.175px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#90a1b9] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Button12() {
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[117.388px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#90a1b9] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[117.388px]">
        <Icon2 />
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[36.8px] not-italic text-[14px] text-neutral-950 text-nowrap top-[4.8px] whitespace-pre">Send Email</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[32px] relative shrink-0 w-[351.025px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[32px] items-center relative w-[351.025px]">
        <Button />
        <Button11 />
        <Button12 />
      </div>
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.07px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">DAILY COLLECTION REPORT (DCR)</p>
    </div>
  );
}
...
function HeaderCell() {
  return (
    <div className="absolute h-[40.8px] left-0 top-0 w-[95.125px]" data-name="Header Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Bold',_sans-serif] leading-[24px] left-[16.4px] not-italic text-[16px] text-neutral-950 text-nowrap top-[6.2px] whitespace-pre">DATE</p>
    </div>
  );
}
...
function HeaderCell1() {
  return (
    <div className="absolute h-[40.8px] left-[95.13px] top-0 w-[397.25px]" data-name="Header Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Bold',_sans-serif] leading-[24px] left-[198.81px] not-italic text-[16px] text-center text-neutral-950 text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">COLLECTION DETAIL</p>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="absolute h-[40.8px] left-[492.38px] top-0 w-[138.1px]" data-name="Header Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Bold',_sans-serif] leading-[24px] left-[69.4px] not-italic text-[16px] text-center text-neutral-950 text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">AMOUNT</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="absolute h-[40.8px] left-[630.48px] top-0 w-[200.725px]" data-name="Header Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Bold',_sans-serif] leading-[24px] left-[100.9px] not-italic text-[16px] text-center text-neutral-950 text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">DEMAND SHIFT</p>
    </div>
  );
}
...
function TableRow() {
  return (
    <div className="absolute bg-gray-100 h-[40.8px] left-0 top-0 w-[831.2px]" data-name="Table Row">
      <HeaderCell />
      <HeaderCell1 />
      <HeaderCell2 />
      <HeaderCell3 />
...
function TableHeader() {
  return (
    <div className="absolute h-[40.8px] left-[0.4px] top-[0.4px] w-[831.2px]" data-name="Table Header">
      <TableRow />
    </div>
  );
}
...
function TableCell() {
  return (
    <div className="absolute h-[40.8px] left-0 top-0 w-[95.125px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[24px] left-[47.75px] not-italic text-[16px] text-center text-neutral-950 text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">1</p>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="absolute h-[40.8px] left-[95.13px] top-0 w-[315.575px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="absolute h-[40.8px] left-[410.7px] top-0 w-[81.675px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[40.8px] left-[492.38px] top-0 w-[138.1px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="absolute h-[40.8px] left-[630.48px] top-0 w-[200.725px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="absolute h-[40.8px] left-0 top-0 w-[831.2px]" data-name="Table Row">
      <TableCell />
      <TableCell1 />
      <TableCell2 />
      <TableCell3 />
...
function TableCell6() {
  return (
    <div className="absolute h-[40.8px] left-[95.13px] top-0 w-[315.575px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[24px] left-[157.97px] not-italic text-[#e7000b] text-[16px] text-center text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">INCOME FUND</p>
    </div>
  );
}
...
function TableRow2() {
  return (
    <div className="absolute h-[40.8px] left-0 top-[40.8px] w-[831.2px]" data-name="Table Row">
      <TableCell5 />
      <TableCell6 />
      <TableCell7 />
      <TableCell8 />
...
function TableCell11() {
  return (
    <div className="absolute h-[40.8px] left-[95.13px] top-0 w-[315.575px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[24px] left-[157.96px] not-italic text-[#e7000b] text-[16px] text-center text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">EARNED FUND</p>
    </div>
  );
}
...
function TableRow3() {
  return (
    <div className="absolute h-[40.8px] left-0 top-[81.6px] w-[831.2px]" data-name="Table Row">
      <TableCell10 />
      <TableCell11 />
      <TableCell12 />
      <TableCell13 />
...
function TableCell16() {
  return (
    <div className="absolute h-[40.8px] left-[95.13px] top-0 w-[315.575px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[24px] left-[158.25px] not-italic text-[#e7000b] text-[16px] text-center text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">EXPENDITURE</p>
    </div>
  );
}
...
function TableCell17() {
  return (
    <div className="absolute h-[40.8px] left-[410.7px] top-0 w-[81.675px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[24px] left-[41.16px] not-italic text-[16px] text-center text-neutral-950 text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">0.00</p>
    </div>
  );
}
...
function TableRow4() {
  return (
    <div className="absolute h-[40.8px] left-0 top-[122.4px] w-[831.2px]" data-name="Table Row">
      <TableCell15 />
      <TableCell16 />
      <TableCell17 />
      <TableCell18 />
...
function TableCell21() {
  return (
    <div className="absolute h-[40.8px] left-[95.13px] top-0 w-[315.575px]" data-name="Table Cell">
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[24px] left-[158.61px] not-italic text-[#e7000b] text-[16px] text-center text-nowrap top-[6.2px] translate-x-[-50%] whitespace-pre">INCOME OVER EXPENDITURE</p>
    </div>
  );
}
...
function TableRow5() {
  return (
    <div className="absolute h-[40.8px] left-0 top-[163.2px] w-[831.2px]" data-name="Table Row">
      <TableCell20 />
      <TableCell21 />
      <TableCell22 />
      <TableCell23 />
...
function TableBody() {
  return (
    <div className="absolute h-[204px] left-[0.4px] top-[41.2px] w-[831.2px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Table() {
  return (
    <div className="h-[245.6px] relative shrink-0 w-full" data-name="Table">
      <div className="h-[245.6px] overflow-clip relative rounded-[inherit] w-full">
        <TableHeader />
        <TableBody />
      </div>
      <div aria-hidden="true" className="absolute border-[#99a1af] border-[0.8px] border-solid inset-0 pointer-events-none" />
...
export default function FeeIncomeReportDailyCollection() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Fee Income Report / Daily Collection">
      <App />
    </div>
  );
}