import svgPaths from "./svg-bzzutfyz05";
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.07px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">Year Wise Income Report</p>
    </div>
  );
}
...
export default function FeeIncomeReportYearWiseIncome() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Fee Income Report / Year Wise Income">
      <App />
    </div>
  );
}