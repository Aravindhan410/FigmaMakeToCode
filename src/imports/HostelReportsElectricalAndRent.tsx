import svgPaths from "./svg-2ms2o59n29";
...
function Container() {
  return (
    <div className="h-[32px] relative shrink-0 w-[241px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[32px] items-center justify-center relative w-[241px]">
        <Button />
      </div>
    </div>
  );
...
function Container2() {
  return (
    <div className="absolute content-stretch flex gap-[492.775px] h-[32px] items-center justify-center left-[12px] top-[12px] w-[1096px]" data-name="Container">
      <Container />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.57px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">Student Room Rent, Electrical Charge and Fitting</p>
    </div>
  );
}
...
export default function HostelReportsElectricalAndRent() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Hostel Reports/Electrical and Rent">
      <App />
    </div>
  );
}