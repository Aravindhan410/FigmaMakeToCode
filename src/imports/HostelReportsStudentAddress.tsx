import svgPaths from "./svg-4whit28ys5";
...
export default function HostelReportsStudentAddress() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Hostel Reports/Student Address">
      <App />
    </div>
  );
}