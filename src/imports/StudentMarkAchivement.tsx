...
function Card() {
  return (
    <div className="bg-white h-[296.4px] relative rounded-[14px] shrink-0 w-full" data-name="Card">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] h-[296.4px] items-start p-[0.8px] relative w-full">
          <CardHeader />
          <CardContent />
        </div>
      </div>
...
export default function StudentMarkAchivement() {
  return (
    <div className="bg-gray-50 relative size-full" data-name="Student mark & Achivement">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start pb-0 pt-[32px] px-[135.6px] relative size-full">
          <Card />
        </div>
      </div>
    </div>
