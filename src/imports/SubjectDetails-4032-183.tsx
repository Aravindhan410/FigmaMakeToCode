import svgPaths from "./svg-cyeqlr4hiu";
...
function PrimitiveButton({ isActive, onClick }: { isActive: boolean; onClick: () => void }) {
  return (
    <button 
      onClick={onClick}
      className={`absolute h-[29px] left-[3px] rounded-[14px] top-[3.5px] w-[117.888px] cursor-pointer hover:opacity-90 transition-opacity ${isActive ? 'bg-white' : 'bg-[rgba(255,255,255,0.2)]'}`} 
...
function PrimitiveButton1({ isActive, onClick }: { isActive: boolean; onClick: () => void }) {
  return (
    <button 
      onClick={onClick}
      className={`absolute h-[29px] left-[120.89px] rounded-[14px] top-[3.5px] w-[135.613px] cursor-pointer hover:opacity-90 transition-opacity ${isActive ? 'bg-white' : 'bg-[rgba(255,255,255,0.2)]'}`} 
      data-name="Primitive.button"
    >
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <Icon1 />
...
function TabList({ activeTab, onTabChange }: { activeTab: 'staff' | 'subject'; onTabChange: (tab: 'staff' | 'subject') => void }) {
  return (
    <div className="bg-[#ececf0] h-[36px] relative rounded-[14px] shrink-0 w-[259.5px]" data-name="Tab List">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[36px] relative w-[259.5px]">
        <PrimitiveButton isActive={activeTab === 'staff'} onClick={() => onTabChange('staff')} />
        <PrimitiveButton1 isActive={activeTab === 'subject'} onClick={() => onTabChange('subject')} />
      </div>
    </div>
  );
}
...
function PrimitiveDiv({ activeTab, onTabChange }: { activeTab: 'staff' | 'subject'; onTabChange: (tab: 'staff' | 'subject') => void }) {
  return (
...
function CardContent({ activeTab, onTabChange }: { activeTab: 'staff' | 'subject'; onTabChange: (tab: 'staff' | 'subject') => void }) {
  return (
    <div className="h-[984.8px] relative shrink-0 w-[1117.6px]" data-name="CardContent">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[32px] h-[984.8px] items-start pb-0 pt-[24px] px-[24px] relative w-[1117.6px]">
        <PrimitiveDiv activeTab={activeTab} onTabChange={onTabChange} />
        <StaffDetailsForm5 />
      </div>
    </div>
  );
...
function Card({ activeTab, onTabChange }: { activeTab: 'staff' | 'subject'; onTabChange: (tab: 'staff' | 'subject') => void }) {
  return (
    <div className="bg-white h-[985.6px] relative rounded-bl-[14px] rounded-br-[14px] shrink-0 w-full" data-name="Card">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col h-[985.6px] items-start pb-[0.8px] pt-0 px-[0.8px] relative w-full">
          <CardContent activeTab={activeTab} onTabChange={onTabChange} />
        </div>
      </div>
    </div>
  );
...
function StaffDetailsForm6({ activeTab, onTabChange }: { activeTab: 'staff' | 'subject'; onTabChange: (tab: 'staff' | 'subject') => void }) {
  return (
    <div className="bg-gray-100 content-stretch flex flex-col h-[1049.6px] items-start relative shrink-0 w-full" data-name="StaffDetailsForm">
      <Container1 />
      <Card activeTab={activeTab} onTabChange={onTabChange} />
    </div>
  );
}

function App({ activeTab, onTabChange }: { activeTab: 'staff' | 'subject'; onTabChange: (tab: 'staff' | 'subject') => void }) {
  return (
    <div className="bg-gray-100 h-[1081.6px] relative shrink-0 w-full" data-name="App">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col h-[1081.6px] items-start pb-0 pt-[16px] px-[16px] relative w-full">
          <StaffDetailsForm6 activeTab={activeTab} onTabChange={onTabChange} />
        </div>
      </div>
    </div>
  );
...
export default function SubjectDetails({ activeTab, onTabChange }: { activeTab?: 'staff' | 'subject'; onTabChange?: (tab: 'staff' | 'subject') => void }) {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="subject details">
      <App activeTab={activeTab || 'subject'} onTabChange={onTabChange || (() => {})} />
    </div>
  );
}