import svgPaths from "./svg-6gqg67q07x";
...
function Button() {
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[50px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#90a1b9] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[50px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[7px] not-italic text-[14px] text-neutral-950 text-nowrap top-[6px] whitespace-pre">Show</p>
      </div>
    </div>
  );
}
...
function PrimitiveLabel() {
  return (
    <div className="h-[20px] relative shrink-0 w-[73px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center relative w-[73px]">
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Veh. Regno</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan() {
  return (
    <div className="h-[20px] relative shrink-0 w-[50.4px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[50.4px]" />
    </div>
  );
}
...
function PrimitiveButton() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[79px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border-[#d1d5dc] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[36px] items-center justify-between px-[12.8px] py-[0.8px] relative w-[79px]">
        <PrimitiveSpan />
        <Icon />
      </div>
    </div>
...
function Container() {
  return (
    <div className="h-[36px] relative shrink-0 w-[160px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[36px] items-center relative w-[160px]">
        <PrimitiveLabel />
        <PrimitiveButton />
      </div>
    </div>
...
function PrimitiveLabel1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[38px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center relative w-[38px]">
        <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Driver</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[36px] relative shrink-0 w-[125px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[36px] items-center relative w-[125px]">
        <PrimitiveLabel1 />
        <PrimitiveButton1 />
      </div>
    </div>
...
function Container4() {
  return (
    <div className="h-[32px] relative shrink-0 w-[241px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[32px] items-center justify-end relative w-[241px]">
        <Button12 />
        <Button13 />
      </div>
    </div>
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.07px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">KMPL Report</p>
    </div>
  );
}
...
export default function TransportKmplReport() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Transport/KMPL Report">
      <App />
    </div>
  );
}