import svgPaths from "./svg-k3oj4jlc9o";
...
function Container1() {
  return (
    <div className="absolute bg-white h-[60px] left-0 top-0 w-[1120px]" data-name="Container1">
      <Container />
      <ReportFilters />
    </div>
  );
...
function Container31() {
  return (
    <div className="absolute bg-gray-100 box-border content-stretch flex flex-col h-[32.8px] items-start left-[-7px] pb-[0.8px] pl-[16px] pr-[1027.83px] pt-[7.2px] top-[57px] w-[1120px]" data-name="Container">
...
function OfficeReportHeader() {
  return (
    <div className="bg-slate-100 h-[90px] relative shrink-0 w-[1120px]" data-name="OfficeReportHeader">
      <div aria-hidden="true" className="absolute border-[#cad5e2] border-[0px_0px_0.8px] border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[90px] relative w-[1120px]">
        <Container1 />
        <Container31 />
      </div>
    </div>
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.57px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">Vehicle Report</p>
    </div>
  );
}
...
export default function VehicleReport() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Vehicle Report">
      <App />
    </div>
  );
}