import svgPaths from "./svg-p68bycnzjy";
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[71px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[71px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[30px] not-italic text-[14px] text-neutral-950 text-nowrap top-[-1.2px] whitespace-pre">Vendor</p>
      </div>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[71px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[71px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[30px] not-italic text-[14px] text-neutral-950 text-nowrap top-[-1.2px] whitespace-pre">Bill No</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[68px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[68px]">
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-neutral-950 text-nowrap top-[-1.2px] whitespace-pre">From Date</p>
      </div>
    </div>
  );
}
...
function Label3() {
  return (
    <div className="relative shrink-0 w-[45px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[10px] items-center relative w-[45px]">
  ...
  return (
    <div className="bg-slate-200 h-[32px] relative rounded-[8px] shrink-0 w-[129.463px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[129.463px]">
        <Icon />
        <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[36.8px] not-italic text-[14px] text-neutral-950 text-nowrap top-[4.8px] whitespace-pre">Show Report</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-[99.2px] w-[832px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[28px] left-[416.07px] not-italic text-[20px] text-center text-neutral-950 text-nowrap top-[-2.2px] translate-x-[-50%] whitespace-pre">Vendor Report</p>
    </div>
  );
}
...
export default function VendorReport() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Vendor Report">
      <App />
    </div>
  );
}